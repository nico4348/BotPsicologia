...
async function modificarCita(idCita, nuevoHorario) {
    try {
        ...
        const horaIndex = horarioActualizado[nuevoHorario.dia]
            .indexOf(nuevoHorario.hora);
        if (horaIndex > -1) {
...
try {
    ...
    if (pruebaControladorAgendamiento && pruebaControladorAgendamiento.practicante && pruebaControladorAgendamiento.horarios.length > 0) {
